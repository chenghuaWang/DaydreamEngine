...
void obj_layer::update() {
  if (m_menu != nullptr) { m_menu->update(); }
...
void obj_layer::register_menu(const REF(menu) & rhs) { m_menu = rhs; }

void obj_layer::set_flags(ImGuiWindowFlags a) { m_flags = a; }

void obj_layer::set_opened(bool enable) { p_open = enable; }

void obj_layer::set_wopened(bool enable) { w_open = enable; }
...
void menu_layer::register_menu(const REF(menu) & rhs) { m_menu = rhs; }

REF(menu) & menu_layer::get_menu() { return m_menu; }
