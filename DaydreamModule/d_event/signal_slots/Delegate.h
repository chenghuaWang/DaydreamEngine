 ...
 *
 *	License:
 *	As stated explicitly in the article linked above, this code is released into the public
...
//				  * Added delegate::empty() to test if invocation is safe (Thanks Neville
//Franks).
...
//				  * MFP conversion now works for CodePlay (but not yet supported in the
//full code).
//				  * Now compiles without warnings on _any_ supported compiler, including
//BCC 5.5.1
...
//				  * Bugfix for Metrowerks: empty() was buggy because a valid MFP can be 0
//on MWCC!
...
class ClosurePtr : public DelegateMemento {
 public:
  ...
  inline void bindmemfunc(X* pthis, XMemFunc function_to_bind) {
    m_pthis =
        SimplifyMemFunc<sizeof(function_to_bind)>::Convert(pthis, function_to_bind, m_pFunction);
#if !defined(FASTDELEGATE_USESTATICFUNCTIONHACK)
    m_pStaticFunction = 0;
#endif
  }
...
#ifdef FASTDELEGATE_GCC_BUG_8271  // At present, GCC doesn't recognize constness of MFPs in
                                  // templates
  template<class X, class XMemFunc>
 ...
 public:
  ...
  inline bool IsEqualToStaticFuncPtr(StaticFuncPtr funcptr) {
    ...
    // For the Evil method, if it doesn't actually contain a static function, this will return an
    // arbitrary value that is not equal to any valid function pointer.
    else
...
class Delegate3 {
 ...
 public:
  ...
  Delegate3(const Y* pthis,
            DesiredRetType (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3) const) {
    m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
  }
  template<class X, class Y>
  inline void Bind(const Y* pthis,
...
class Delegate4 {
 ...
 public:
  ...
  // Binding to const member functions.
  template<class X, class Y>
  Delegate4(const Y* pthis, DesiredRetType (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                                  Param4 p4) const) {
    m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);
  }
  template<class X, class Y>
...
class Delegate5 {
 ...
 public:
  ...
  // Binding to non-const member functions
  template<class X, class Y>
  Delegate5(Y* pthis, DesiredRetType (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                            Param4 p4, Param5 p5)) {
    m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind);
  }
  template<class X, class Y>
  ...
  // Binding to const member functions.
  template<class X, class Y>
  Delegate5(const Y* pthis, DesiredRetType (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate5(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                               Param5 p5)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
class Delegate6 {
 ...
 public:
  ...
  // Binding to non-const member functions
  template<class X, class Y>
  Delegate6(Y* pthis, DesiredRetType (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate6(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                               Param5 p5, Param6 p6)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
 ...
 private:  // Invoker for static functions
  RetType InvokeStaticFunction(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
                               Param6 p6) const {
...
class Delegate7 {
 ...
 public:
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate7(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                               Param5 p5, Param6 p6, Param7 p7)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
 ...
 private:  // Invoker for static functions
  RetType InvokeStaticFunction(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6,
                               Param7 p7) const {
...
class Delegate8 {
 ...
 public:
  ...
  // Binding to const member functions.
  template<class X, class Y>
  Delegate8(const Y* pthis, DesiredRetType (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3,
                                                                  Param4 p4, Param5 p5, Param6 p6,
  ...
  // Static functions. We convert them into a member function call.
  // This constructor also provides implicit conversion
  Delegate8(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                               Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
    Bind(function_to_bind);
  }
  // for efficiency, prevent creation of a temporary
...
class Delegate<R(Param1, Param2, Param3, Param4, Param5, Param6)>
 ...
 public:
  ...
  template<class X, class Y>
  Delegate(const Y* pthis, R (X::*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4,
                                                    Param5 p5, Param6 p6) const)
      : BaseType(pthis, function_to_bind) {}
...
Delegate2<Param1, Param2, FASTDLGT_RETTYPE> MakeDelegate(Y* x,
...
Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE> MakeDelegate(
    Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6,
                             Param7 p7)) {
  return Delegate7<Param1, Param2, Param3, Param4, Param5, Param6, Param7, FASTDLGT_RETTYPE>(x,
                                                                                             func);
}
...
Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8, FASTDLGT_RETTYPE>
MakeDelegate(Y* x, RetType (X::*func)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5,
                                      Param6 p6, Param7 p7, Param8 p8)) {
  return Delegate8<Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8,
